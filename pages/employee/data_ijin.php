	      ...
	      <div class="container-fluid">  
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Master Ijin
                           
						  </h6><div align="right"> <a class="btn btn-primary" href="../../pages/employee/input_ijin.php"  name="submit">Tambah</a></div>
                        <div class="card-body">
						<table id="data-table" class="table table-striped table-bordered table-hover responsive nowrap" style="width:100%" >
                                    ...
                                    <tbody>
									 <?php 
										$result = pg_query($con, " SELECT * FROM m_ijin");
											while($data = pg_fetch_array($result, NULL, PGSQL_ASSOC)){ 
												$id_ijin = $data['id_ijin']; ;
												$tgl_awal = $data['jenis_ijin']; 
												$status =   $data['status'];
										?>
                                        <tr>
                                            <td  style="text-align:center;"><?php echo $data["id_ijin"]; ?></td>
