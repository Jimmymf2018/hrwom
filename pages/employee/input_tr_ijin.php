...
.slider.round:before {
  border-radius: 50%;
    ...
    <section class="content"> 
     ...
     <form role="form" action="../../model/in_tr_ijin.php" enctype="multipart/form-data" method="POST">  
       <div class="box-body">
                        ...
                        <div class="card-body">
								 ...
								 <div class="col-md-4 mb-3">
									<div class="form-group">
									  <label for="jenis_ijin">Jenis Ijin</label> 
									   <select  class="form-control"  id="jenis_ijin"   name="jenis_ijin" onchange="changeValue(this.value)">
													  <option disabled selected> Pilih </option>
													 <?php 
													  $sql=pg_query($con,"SELECT * FROM m_ijin");
													  $jsArray = "var prdName = new Array();\n";
													  while($data = pg_fetch_array($sql, NULL, PGSQL_ASSOC)){ 
													 ?>
													   <option value="<?=$data['jenis_ijin']?>"><?=$data['jenis_ijin']?></option>   
													 <?php  
													 $jsArray .= "prdName['".$data['id_ijin']."'] = {jumlah:'".addslashes($data['jumlah'])."'};\n"; 
													  }
													 ?>
													  </select>
									</div>
                          ...
                          <div class="form-row">
                            ...
                            <div class="form-row">
								 <div class="col-md-2 mb-3">
									<div class="form-group">
									  <label for="nama_dept">Atasan</label>  
									  <input type="text" class="form-control"   id="nik_atasan"  name="nik_atasan"   placeholder="Keterangan">
									</div>
								 </div> 
								 <div class="col-md-3 mb-3">
									<div class="form-group">
									  <label for="nama_dept">Tanggal Approve</label>
									 <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
									  <input type="text" class="form-control datetimepicker-input" id="tgl_approve"  name="tgl_approve"   data-target="#datetimepicker3"  placeholder="Tanggal Awal"/>
