	      ...
	      <div class="container-fluid">  
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Input Cabang</h6>
                        </div>
						
     <form role="form" action="../../model/in_cabang.php" enctype="multipart/form-data" method="POST">  
       <div class="box-body">
