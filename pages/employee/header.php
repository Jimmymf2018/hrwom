        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
	     ...
	     <li class="nav-item dropdown no-arrow">
			<a class="nav-link dropdown-toggle" href="javascript:;" id="userDropdown" role="button"
				...
				<img class="img-profile rounded-circle"	src="../../model/foto_user/<?php echo $_SESSION['imagefile']; ?>">  
			</a> 
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
     ...
     <nav class="mt-2">
		...
		<?php  if ($_SESSION['nama_level']=='Administrator' || $_SESSION['nama_level']=='hrd' )
			 {
			?>
          <li class="nav-item has-treeview menu-open">
            <a href="../../pages/container.php" class="nav-link active">
		   ...
		   <?php } 
		    if ( $_SESSION['nama_level']=='Administrator' || $_SESSION['nama_level']=='hrd'){ 
			?>
		   <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
			 <li class="nav-item">
                <a href="../../pages/employee/data_cabang.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Cabang</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../pages/employee/data_cuti.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Cuti</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../pages/employee/data_ijin.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Ijin</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../pages/employee/data_libur.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Libur</p>
                </a>
              </li> 
			   <li class="nav-item">
                <a href="../../pages/employee/data_departemen.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Departemen</p>
                </a>
              </li> 
			    <li class="nav-item">
                <a href="../../pages/employee/data_jabatan.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Jabatan</p>
                </a>
              </li> 
			   <li class="nav-item">
                <a href="../../pages/employee/data_user.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master User</p>
                </a>
              </li> 
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../../pages/employee/data_event.php" class="nav-link">
