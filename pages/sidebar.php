      ...
      <!-- Sidebar Menu -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="container.php" class="nav-link active">
		   ...
		   <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
				<li class="nav-item">
                <a href="employee/data_cabang.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Cabang</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="employee/data_cuti.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Cuti</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="employee/data_ijin.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Ijin</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="employee/data_libur.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Libur</p>
                </a>
              </li> 
			   <li class="nav-item">
                <a href="employee/data_departemen.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Departemen</p>
                </a>
              </li> 
			    <li class="nav-item">
                <a href="employee/data_jabatan.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master Jabatan</p>
                </a>
              </li> 
			  <li class="nav-item">
                <a href="employee/data_user.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Master User</p>
                </a>
              </li> 
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="employee/data_event.php" class="nav-link">
