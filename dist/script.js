...
Promise.all([
	faceapi.nets.tinyFaceDetector.loadFromUri('/hrwom/models'),
	faceapi.nets.faceLandmark68Net.loadFromUri('/hrwom/models'),
	faceapi.nets.faceRecognitionNet.loadFromUri('/hrwom/models'),
	faceapi.nets.faceExpressionNet.loadFromUri('/hrwom/models')
]).then(startWebcam);
